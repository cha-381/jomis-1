       ...
       <div class="row">
        <div class="col-md-3">
          <a href="name_jo.php"  id="myButton" class="btn btn-primary btn-block mb-3">Create Job Order</a>
           <a href="list_jo_copy.php"  id="myButton" class="btn btn-primary btn-block mb-3">Sample</a>
        </div>
      </div>
              ...
              <div class="card-body text-l">
                <table id="users" class="table table-bordered table-striped" style="background-color: #f1f1f1;">
                  <thead>
                    ...
                    <th  width="15%" style="text-align:center;">Period Covered</th>
                  ...
                  <tbody>
                     <?php if($count>0){
            $n  =   1; while ($get_list = $get_combine3_data-> fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
