              ...
              <div class="card-body">
                <div class="tab-content" >
                  <div class="active tab-pane " id="activity">
                    <!-- Post -->
                       <h4>List of Employees  <a href="employeedetails.php?ID=<?php echo "1"?>" id="myBtn"  <?php echo $btnStatus?> class="btn btn-primary">All</a> <a href="employee_active.php?ID=<?php echo "1"?>" id="myBtn"  <?php echo $btnStatus?> class="btn btn-primary">Active</a>  <a href="employee_inactive.php?ID=<?php echo "1"?>" id="myBtn"  <?php echo $btnStatus?> class="btn btn-primary">Inactive</a></h4>
          ...
          <div class="card card-info">
            ...
            <?php if ($emp_data['E_Status']=="Active")  {?> 
                   ...
                   <td> <?php if ($emp_data['EmpExt']=="")  {?> 
                    <?php echo ucwords(strtolower($emp_data['EmpFname'] . " " . $emp_data['EmpMname'][0] ."." . " " . $emp_data['EmpLname']))?></td>
            ...
            <?php }elseif($emp_data['E_Status']=="Inactive") {?>  
             ...
             <?php if ($emp_data['Report']=="Pending")  {?> 
                       <td align="center">
                          <a href="employee_status.php?ID=<?php echo $emp_data['EmpCode']; ?>" style="color:blue" ><?php echo "Pending"?>
                          </a>  
                    </td>
            <?php }elseif($emp_data['Report']=="Verified") {?>
                        <td align="center">
                          <a href="employee_status.php?ID=<?php echo $emp_data['EmpCode']; ?>"style="color:green" style="color:black" ><?php echo "Verified"?>
                          </a>  
                    </td>
             <?php }elseif($emp_data['Report']=="Modify") {?>
                        <td align="center">
                          <a href="employee_status.php?ID=<?php echo $emp_data['EmpCode']; ?>" style="color:red"><?php echo "Modify"?>
                          </a>  
                    </td>
                     <?php } ?> 
 ...
 <!-- /.tab-pane -->
      ...
      <?php }elseif($emp_data['Period']!="" && $emp_data['Month1']!="" && $emp_data['Month2']=="") {?>
       ...
       <?php }elseif($emp_data['Period']!="" && $emp_data['Month1']=="" && $emp_data['Month2']=="") {?>
                    ...
                    <td style="text-align:left; font-size:14px"><?php echo number_format($emp_data['Rate']);?></td>
