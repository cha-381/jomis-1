...
<input type="hidden" id="news" name="new_number"  class="form-control" value="<?php echo $get_objid;?>" required>
  ...
  border-spacing="0;" width= "100%;">
            ...
            $n  =   1; while ($sched_data= $get_schedule_data-> fetch(PDO::FETCH_ASSOC)) { ?>
                    ...
                    <?php if ($sched_data['JobOrderNo']==$JobOrder) {
                     ?> 
                   <td><?php echo $n++; ?></td>
                    <td><?php echo ucwords(strtolower($sched_data['FName']. " " . $sched_data['MName'][0] ."." . " " . $sched_data['LName']));?></td>
      ...
      <?php }elseif($sched_data['Period']!="" && $sched_data['Month1']!="" && $sched_data['Month2']=="") {?>
       ...
       <?php }elseif($sched_data['Period']!="" && $sched_data['Month1']=="" && $sched_data['Month2']=="") {?>
               ...
               <?php if ($btnStatus=='enabled') {?>
                  <a class="btn btn-outline-primary btn-xs" href="edit_jo2.php?id=<?php echo $sched_data['id']; ?>" data-toggle="tooltip" title="Edit"><img class="img-fluid img-square"
                ...
                <div class="row">
                    <div class="col-sm-2">
                      <div class="form-group">
                        ...
                        <input type="text" id="laborers" class="form-control" name="jo_laborers" readonly value="<?php echo $laborers1;?>" required>
...
<input type="hidden" id="" name="jo_sub"  class="form-control" value="<?php echo "-"?>" required>
                   ...
                   <input type="hidden" id="amount" class="form-control" name="job_date" value="<?php echo date("F d,Y");?>"  required>
                      ...
                      <input type="hidden" id="amount" class="form-control" name="jo_amount" value="<?php echo $amount1;?>"  required>
...
<!-------------------- modals here --------------------------------->
   <div id="myModal2" class="modal" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-header bg-danger">
              <h3><i class="fa fa-plus-square-o"></i> WORK TO BE DONE</h3>
              <span class="close2">&times;</span>
           
        </div>
     <form class="form-horizontal" method="POST" action="update_item.php">

<input type="hidden" name="objid" id="new1" value="" class="form-control">  
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                    <label>Item</label>
                    <input type="text" name="Item1" onclick="mysync()" id="" class="form-control">
                    </div>
                  </div>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-header bg-info">
     ...
     <form class="form-horizontal" method="POST" action="insertjob.php">
...
<input type="hidden" name="" id="add" value="<?php echo $amount1;?>" class="form-control"> 

<input type="hidden" name="jo_add" id="add2" value="" class="form-control">     
     
<input type="hidden" name="jo_photo" id="jo_photo" value="" class="form-control">  

<input type="hidden" name="jo_total" id="jo_total" value="<?php echo $laborers1 * 1 + 1;?>" class="form-control">     
...
<input type="hidden" name="jo_total_amount" id="jo_total_amount" value="<?php echo $db_charges?>" class="form-control" name="jo_charges"> 
 ...
 <?php if ($get_name['E_Status']=='Active' && $get_name['EmpDept']=='All' OR $get_name['EmpDept']==$db_department ) {?>
   ...
   $get_name['EmpFname']; ?>"><?php echo  $get_name['EmpLname'].","." ".$get_name['EmpFname']. " " . $get_name['EmpMname'][0] ."."  ?></option> <?php } ?><?php } ?>
              ...
              <div class="form-group"> 
                 ...
                 <label style="font-size:14px"> Regular Schedule </label>
                   ...
                   <select class="form-control custom-select" onclick="sync1()" name="period">
                 ...
                 <option>Monday</option>
                  ...
                  <option>Holidays</option>  
                      ...
                      <p> No. of days:</p>
                        ...
                        <div class="col-sm-1">
                      <div class="form-group">
                     <input type="number" placeholder="0" name="jo_day1" onchange="myjoin()" id="add1" class="form-control" id="day1"></div>
                      </div>           
...
<div class="col-sm-3">
                      <div class="input-group">                     
                        <select class="form-control custom-select" name="jo_rate1" id="rate2" >
 ...
 <p> No. of days:</p>
                        ...
                        <div class="col-sm-1">
                      <div class="form-group">
                     <input type="number" value="<?php echo 0;?>" onchange="myjoin()" name="jo_day2" class="form-control"id="day2"></div>
                      </div>           
...
<hr>
    ...
    $get_time2['TimeSched']; ?>"><?php echo $get_time2['TimeSched']?></option> <?php } ?>
                    ...
                    <div class="col-sm-3">
                      <div class="input-group">                        
                        <select class="form-control custom-select" name="jo_rate2" id="rate3">
                  <option selected disabled>0.00</option>
    ...
    $get_rate2['Salary']; ?>"><?php echo $get_rate2['Salary']?></option>
                ...
                <p> No. of days:</p>
                    <div class="col-sm-1">
                      <div class="form-group">
                     <input input type="number" value="<?php echo 0;?>" name="jo_day3"class="form-control" id="day3" onchange="myjoin()"></div>              
                    </div>
 ...
 function myjoin()
{
  ...
  add2.value = (add1.value * rate.value)+(day3.value * rate3.value)+(day2.value * rate2.value)+ (add.value*1);
