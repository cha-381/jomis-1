...
<!-- Main content -->
  ...
  <input type="hidden" class="form-control" readOnly=true id = "emp_id" name="" value="<?php echo $get_emp_id; ?>">
...
<?php }elseif($get_emp_mname!='' && $get_emp_fname!='' && $get_emp_lname!='' && $get_emp_ename!='') {?>
                  ...
                  <lable>ID No.: <?php echo $get_emp_control?></lable>
                   <p></p>
                     <p><i>The following information are considered to be private. All information will be treated as strictly confidential.</i></p>
                    <hr>
                      <input type="hidden" class="form-control"  name="ID" value="<?php echo $get_id_no;?>">  <?php } ?>
                    ...
                    <br>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="input" class="form-control" id="PagIbigNo"  <?php echo $btnStatus; ?> name="PagIbigNo" value="<?php echo $get_id_pagibig;?>">
                        </div>
                      </div>
                      <hr>
                    ...
                    <br>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="input" class="form-control"  <?php echo $btnStatus;?> id="philhealth" name="PhilNo" value="<?php echo $get_id_phil;?>">
                        </div>
                      </div>
                      <hr>
              ...
              <label><i class="h5 mb-0 font-weight-bold bg-yellow">Social Security System</i></label>
                    <br>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="input" class="form-control" id="SSS"  <?php echo $btnStatus; ?> name="SssNo" value="<?php echo $get_id_sss;?>">
                        </div>
                      </div>
                         <hr>
                    ...
                    <br>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="input" class="form-control" id="tin" name="TinNo"  <?php echo $btnStatus; ?> value="<?php echo $get_id_tin;?>">
                        </div>
                      </div>
               ...
               <hr>
                    ...
                    <br>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="input" class="form-control"  <?php echo $btnStatus; ?> id="atm" name="AtmNo" value="<?php echo $get_id_atm;?>">
                        </div>
                        </div>
                    ...
                    <br>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="input" class="form-control"  <?php echo $btnStatus; ?> id="ctcno" name="CtcNo" value="<?php echo $get_id_ctc;?>">
                        </div>
                      </div>
                        <form class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="input" class="form-control" id="dateissued"  <?php echo $btnStatus; ?> name="CtcDate" value="<?php echo $get_id_date;?>">
                        </div>
                      </div>
                           <form class="form-horizontal">
                      <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                          <input type="input" class="form-control"  <?php echo $btnStatus; ?> id="placeissued" name="CtcAt" value="<?php echo $get_id_place;?>">
                        </div>
                      </div>
                      </div>     
                        </div>
