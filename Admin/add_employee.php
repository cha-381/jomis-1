 ...
 <label><i style="color:red; font-size: 14pxs;">Reference Number</i></label>
        ...
        <b> <label>Date of Birth</b><i style="color: red;"> (mm/dd/yyyy)</i></label>
                ...
                <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                         <input type="text" class="form-control" <?php echo $btnStatus; ?> name="child6" >
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB6"  value="">
              </div>
          </div>
        </div>
      </div>
                <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                         <input type="text" class="form-control" <?php echo $btnStatus; ?> name="child7" >
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB7"  value="">
              </div>
          </div>
        </div>
      </div>
                <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                         <input type="text" class="form-control" <?php echo $btnStatus; ?> name="child8" >
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB8"  value="">
              </div>
          </div>
        </div>
      </div>
                <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                         <input type="text" class="form-control" <?php echo $btnStatus; ?> name="child9" >
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB9"  value="">
              </div>
          </div>
        </div>
      </div>  
                <div class="row">
                    <div class="col-sm-8">
                      <div class="form-group">
                         <input type="text" class="form-control" <?php echo $btnStatus; ?> name="child10" >
                      </div>
                    </div>
                    <div class="col-sm-4">
                      <div class="form-group">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB10"  value="">
              </div>
          </div>
        </div>
      </div>
    ...
    $get_dept['department']; ?>"><?php echo $get_dept['department']; ?></option> <?php } ?>
             ...
             <div class="col-sm-3">
                ...
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="dateStart" placeholder="Date" value="">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                        <input type="text" class="form-control" <?php echo $btnStatus; ?> name="enddate">
                     </div>
          </div>
           </div>
             </div>
