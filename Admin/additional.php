...
<!-- Content Wrapper. Contains page content -->
            ...
            <div class="card card-outline card-success ">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#department" data-toggle="tab">Department/Office</a></li>
 ...
 <!-- /.tab-pane -->
   ...
   <div class="tab-pane fade" id="department">             <?php echo $alert_msg1;?>
                    <h3>List of Deparment/Offices</h3>
          ...
          <div class="row">
            <div class="col-lg-12">
             ...
             <div class="card card-success card-widget">
              <div class="card-header">
                <div class="user-block">
                  <img class="img-square" src="../dist/img/office.png" alt="User Image">
                  <span class="username"><a href="#">Add</a></span>
                    <span class="description" style="color:black">Department/Office</span>
                </div>
                                    <div class="card-tools">
                      <span class="badge badge-danger"></span>
                      <button type="button" href="#myModal3" id="myBtn2" class="btn btn-warning" <?php echo $btnStatus;?> name=""><b><i class="fa fa-plus"></i></b></button>
              ...
              <div class="card-body table-responsive p-0" style="height: 500px;">
                ...
                <table id="user" class="table table-bordered table-striped table-hover" cellspacing="1" cellpadding="8"  style="background-color: #f1f1f1;" >
                  <thead>
                                      <tr bgcolor="lightgreen">
                      <th style="text-align:center;" width="10%">No.</th>
                     <th style="text-align:center;" width="65%">Department/Office</th>
                    </tr>
                  </thead>
                  <tbody>
                                   <?php  
            $n  =   1; while ($dept_data= $get_depart3_data-> fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>

                    <td style="text-align:center;"><?php echo $n++;?></td>
                    <td style="text-align:left;"><?php echo $dept_data['department'] ?></td>
