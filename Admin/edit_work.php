...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="col-sm-6">
      ...
      <li class="breadcrumb-item active">Work Experience</li>
        <li class="breadcrumb-item"><a href="edit_attachement.php?ID=<?php echo $get_emp_id;?>">Work Experience</a></li>
...
<!-- Main content -->
 ...
 <?php }elseif($get_emp_mname!='' && $get_emp_fname!='' && $get_emp_lname!='' && $get_emp_ename!='') {?>
  <h3><?php echo ucwords(strtolower($get_emp_fname . " " . $get_emp_mname[0] ."." . " " . $get_emp_lname.","." ".$get_emp_ename))?></h3>
   <?php } ?>
 ...
 <label><i class="h3 mb-0 font-weight-bold bg-yellow">Employeer 1</i></label>
                    <br>
                      ...
                      <div class="form-group row">
                       <label for="inputName" class="col-sm-3 col-form-label">Employeer:</label>
                        <div class="col-sm-8">
                           <input type="input" class="form-control" id="SSS" <?php echo $btnStatus;?> name="Employer1Name" value="<?php echo $get_exp_emp1_name;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Designation:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" id="SSS" <?php echo $btnStatus;?> name="Employer1Designation" value="<?php echo $get_exp_emp1_designation;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Salary:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" <?php echo $btnStatus;?> id="SSS" name="Employer1CTC" value="<?php echo $get_exp_emp1_salary;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Work Duration:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" <?php echo $btnStatus;?>  id="SSS" name="Employer1WorkDuration" value="<?php echo $get_exp_emp1_duration;?>">
                        </div>
                      </div>
                    ...
                    <br>
                      ...
                      <div class="form-group row">
                       <label for="inputName" class="col-sm-3 col-form-label">Employeer:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" <?php echo $btnStatus;?> id="SSS" name="Employer2Name" value="<?php echo $get_exp_emp2_name;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Designation:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" <?php echo $btnStatus;?> id="SSS" name="Employer2Designation" value="<?php echo $get_exp_emp2_designation;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Salary:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" <?php echo $btnStatus;?> id="SSS" name="Employer2CTC" value="<?php echo $get_exp_emp2_salary;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Work Duration:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" id="SSS" <?php echo $btnStatus;?> name="Employer2WorkDuration" value="<?php echo $get_exp_emp2_duration;?>">
                        </div>
                      </div>
                       <hr>
                   <label><i class="h3 mb-0 font-weight-bold bg-yellow">Employeer 3</i></label>
                    <br>
                      ...
                      <div class="form-group row">
                       <label for="inputName" class="col-sm-3 col-form-label">Employeer:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" id="SSS" <?php echo $btnStatus;?> name="Employer3Name" value="<?php echo $get_exp_emp3_name;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Designation:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" <?php echo $btnStatus;?> id="SSS" name="Employer3Designation" value="<?php echo $get_exp_emp3_designation;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Salary:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" <?php echo $btnStatus;?> id="SSS" name="Employer3CTC" value="<?php echo $get_exp_emp3_salary;?>">
                        </div>
                      </div>
                      ...
                      <label for="inputName" class="col-sm-3 col-form-label">Work Duration:</label>
                        <div class="col-sm-8">
                          <input type="input" class="form-control" <?php echo $btnStatus;?> id="SSS" name="Employer3WorkDuration" value="<?php echo $get_exp_emp3_duration;?>">
                        </div>
                      </div>
                        </div>
                      </div>
