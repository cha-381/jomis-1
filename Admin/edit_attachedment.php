...
<!-- Content Wrapper. Contains page content -->
    ...
    <div class="col-sm-3">
      ...
      <li class="breadcrumb-item"><b><i style="font-size:20px; color:red;" class="fa fa-arrow-right"></b></i><li class="breadcrumb-item active">Barangay Recommendation </li>
      ...
      <li class="breadcrumb-item"><a href="edit_employee.php?ID=<?php echo $get_emp_id;?>">Personal Information</a></li>
        <li class="breadcrumb-item"><a href="edit_attachedment3.php?ID=<?php echo $get_emp_id;?>">Community Tax Certificate</a></li>
...
<!-- Main content -->
         ...
         <div class="card-body">     
           <div class="container">
            <?php echo $alert_msg; ?>
                <i style="font-size:25px"><i style="color:blue" >Barangay Recommendation</i></i>  
