...
<?php }elseif($get_emp_mname!='' && $get_emp_fname!='' && $get_emp_lname!='' && $get_emp_ename=='') {?>
   <input type="hidden" class="form-control" name="Status" readonly="true" value="<?php echo $get_emp_id;?>" >
                ...
                <h3 class="profile-username text-center"><?php echo ucwords(strtoupper($get_emp_fname . " " . $get_emp_mname[0] ."." . " " . $get_emp_lname)) ?></h3>
 ...
 <?php }elseif($get_emp_mname!='' && $get_emp_fname!='' && $get_emp_lname!='' && $get_emp_ename!='') {?>
                ...
                <h3 class="profile-username text-center"><?php echo ucwords(strtoupper($get_emp_fname . " " . $get_emp_mname[0] ."." . " " . $get_emp_lname.","." ".$get_emp_ename))?></h3>
...
<div class="card">
          ...
          <div class="card card-info">
             ...
             <?php if ($emp_data['E_Status']=="Active")  {?> 
                   <td> <a href="employeedetails.php?ID=<?php echo $emp_data['ID']; ?>"> <?php if ($emp_data['EmpExt']=="" Or $emp_data['EmpExt']=="N/A" Or $emp_data['EmpExt']=="n/a" or $emp_data['EmpExt']=="None" Or $emp_data['EmpExt']=="none")  {?> 
                    ...
                    <?php }elseif($emp_data['EmpExt']<>"") {?> 
                      <?php echo ucwords(strtupper($emp_data['EmpFname'] . " " . $emp_data['EmpMname'][0] ."." . " " . $emp_data['EmpLname'].","." ".$emp_data['EmpExt']))?>
                     <?php } ?></a></td>
            ...
            <?php }elseif($emp_data['E_Status']=="Inactive") {?>  
                  <td style="text-align:left; color:red;" > <a href="employeedetails.php?ID=<?php echo $emp_data['ID'];?>"> <?php if ($emp_data['EmpExt']=="" Or $emp_data['EmpExt']=="N/A" Or $emp_data['EmpExt']=="n/a" or $emp_data['EmpExt']=="None" Or $emp_data['EmpExt']=="none")  {?> 
                    <?php echo ucwords(strtupper($emp_data['EmpFname'] . " " . $emp_data['EmpMname'][0] ."." . " " . $emp_data['EmpLname']))?>
                    <?php }elseif($emp_data['EmpExt']<>"") {?> 
                      <?php echo ucwords(strtupper($emp_data['EmpFname'] . " " . $emp_data['EmpMname'][0] ."." . " " . $emp_data['EmpLname'].","." ".$emp_data['EmpExt']))?>
                     <?php } ?></a></td>
 ...
 <!-- /.tab-pane -->
          ...
          <div class="card">
                ...
                <div class="form-group"> 
                    <div class="col-sm-4">
                <a href="../plugins/TCPDF/User/work_record.php?ID=<?php echo $get_emp_code?>"  id="myButton" class="btn btn-success btn-block mb-3">Print Summary</a>
              </div>
            </div>
