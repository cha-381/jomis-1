...
<?php include 'includes/navbar.php'; ?>
  ...
  <section class="content-header">
    ...
    <section class="content">
       <div class="row">
        <div class="col-md-3">
          <a href="list_jo.php"  id="myButton" class="btn btn-primary btn-block mb-3">List of Job Orders</a>
        </div>
      </div>
      ...
      <div class="row">
            ...
            <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF"); ?>">
            	<div class="card-body text-m">
                 <input type="hidden" name="status" id="status" value="<?php echo $allpro?>" class="form-control">
                <table id="users" class="table table-bordered table-striped" style="background-color: #f1f1f1;">
                  <thead>
                   
                      <tr style="font-size: 15px; background-color: hsla(218, 100%, 86%, 0.3)">
                         <th width="2%" style="text-align:center;">No.</th>
                      <th width="9%"style="text-align:center;">Date Created</th>
                       <th width="18%" style="text-align:center;">JO #</th>
                       <th width="18%" style="text-align:center;font-size: 16px; background-color: hsla(0, 43%, 80%, 0.8)">Subject</th>
                      <th width="17%" style="text-align:center;font-size: 16px; background-color: hsla(0, 43%, 80%, 0.8)">Period Covered</th>
                      
                    
                      <th width="8%" style="text-align:center;background-color: hsla(0, 43%, 80%, 0.8)">Payroll #</th>
                      <th width="9%"style="text-align:center; background-color: hsla(0, 43%, 80%, 0.8)">Payroll Amount</th>
                       <th width="10%" style="text-align:center;">Previous Balance</th>
                       <th  width="13%" style="text-align:center; background-color: hsla(0, 43%, 80%, 0.8)">Available Balance</th>
            ...
            $n  =   1; while ($get_list = $get_sched_data-> fetch(PDO::FETCH_ASSOC)) { ?>
               <?php if ($get_list['Department']==$db_department && $get_list['objid_pro']==$allpro) {?>
                    <tr>
                      <td><?php echo $n++; ?></td>
      ...
      <?php } ?>
                     ...
                     <td style="text-align:center;"><?php echo $get_list['PayrollNo'];?></a></td>
                    ...
                    <td style="text-align:right;"><b><?php echo number_format($get_list['AvailableBalance'],2);?></b></td>
