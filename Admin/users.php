...
<?php } ?>
                ...
                <a href="edit_user.php?user_id=<?php echo $get_db_user;?>" class="btn btn-primary btn-block" id='profile_edit'><b>Edit Profile</b></a>
              ...
              <div class="card-body">
                <table id="users" class="table table-bordered table-striped" cellspacing="1" cellpadding="8"   >
                  ...
                  <tbody>
                    ...
                    <?php if ($travel_user['ext_name']=='') {?>
                    <td><?php echo ucwords(strtolower($travel_user['first_name'] . " " . $travel_user['middle_name'][0] ."." . " " . $travel_user['last_name'])) ?></td>
                     <?php }elseif($travel_user['ext_name']<>'') {?>
                      <td><?php echo ucwords(strtolower($travel_user['first_name'] . " " . $travel_user['middle_name'][0] ."." . " " . $travel_user['last_name'].","." ".$travel_user['ext_name'])) ?></td>
                       <?php } ?>
                    <td><?php echo $travel_user['Department'] ?></td>
                   ...
                   <?php if ($travel_user['userStatus']=='Active') {?>
                    ...
                    <td align="center"> <p class="text-danger"><strong><?php echo $travel_user['userStatus'];?></strong></p>
                       ...
                       <?php }elseif($travel_user['userStatus']=='Pending') {?>
                    <td align="center"> <p class="text-orange"><strong><?php echo $travel_user['userStatus'];?></strong></p>
                    <?php } ?>
                    </td>
