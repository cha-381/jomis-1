            ...
            <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF"); ?>">
                ...
                <table id="users" class="table table-bordered table-striped">
                  <thead>
                      ...
                      <th width="25%"style="text-align:center;background-color: hsla(99, 43%, 51%, 0.3)">Project Name</th>
                      <th  width="20%" style="text-align:center;">Project Budget</th>
                  ...
                  <tbody>
                   ...
                   <td> <strong><?php echo $get_project['ProjectName'];?></strong></td>
                    <td style="text-align:right;font-size: 11px"><?php echo  "P"." ".number_format($get_project['ProjectBudget'], 2);?></td>
