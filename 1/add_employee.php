...
<!-- Main content -->
    ...
    $get_dept['department']; ?>"><?php echo $get_dept['department']; ?></option> <?php } ?>
                  ...
                  <option selected>Please select....</option>
                  <?php while ($get_proj = $get_proj_data->fetch(PDO::FETCH_ASSOC)) { ?>  <?php if ($get_proj['Deparment']==$db_department) {?> 
                    <option value="<?php echo
    $get_proj['Department']; ?>"><?php echo $get_proj['Department']; ?></option> <?php } ?>
    <?php } ?>
                </select>
                      </div>
                    </div>
