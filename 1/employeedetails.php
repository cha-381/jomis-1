         ...
         <div class="col-md-9">
          ...
          <div class="card card-info">
                 ...
                 <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Name.." title="Type in a name" style="                 background-position: 10px 10px;
                  ...
                  margin-bottom: 12px;"> 
                   <div class="card-body table-responsive p-0" style="height: 735px;">
                  ...
                  <tbody>
                                  <?php if($count>0){
            $n  =   1;  while ($emp_data= $get_all_emp_data-> fetch(PDO::FETCH_ASSOC)) { ?>
                  

                  <tr>
            <?php if ($emp_data['EmpDept']==$db_department) {?>
                   <td><?php echo $n++; ?></td>
