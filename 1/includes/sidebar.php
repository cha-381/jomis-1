...
<?php } ?>
       ...
       <span class="brand-text font-weight-light"> <p> Dashboard </p>
            ...
            <!-- Divider -->
             ...
             <li class="nav-item has-treeview">
             <a href="includes/paging.php" class="nav-link">
               <img src="../dist/img/list.png" alt="" class="brand-image img-square" width="25" height="25" style="opacity: "> <p  style="text-indent: 10px;"> List</p>
             </a>
