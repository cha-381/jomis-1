          ...
          <div class="card">
           ...
           <i style="font-size:25px"><i style="color:blue" align="center">Personal Information</i></i>  
              ...
              <div class="row">
                ...
                <?php if ($get_emp_photo=='' && $get_status=="Active") {?>
      <div class="col-12 col-sm-3">
               <div class="btn btn-outline-info circle btn-xs" align="left">
                <img class="img-circle elevation-5" id="image" src="../dist/img/no-photo-icon.png" width="200" height="200" vspace="10" alt="" class="brand-image img-square">
              </div>
 <?php }elseif($get_emp_photo=='' && $get_status=="Inactive") {?> 
              <div class="col-12 col-sm-3">
               <div class="btn btn-outline-danger circle btn-xs" align="left">
                <img class="img-circle elevation-5" id="image" src="../dist/img/no-photo-icon.png" width="200" height="200" vspace="10" alt="" >
              </div>

<?php }elseif($get_emp_photo<>'' && $get_status=="Active") {?>
      <div class="col-12 col-sm-3">
               <div class="btn btn-outline-info btn-xs" align="left">
...
<?php }elseif($get_emp_photo<>'' && $get_status=="Inactive") {?>
      <div class="col-12 col-sm-3">
               <div class="btn btn-outline-danger btn-xs" align="left">
                <img class="img-circle elevation-5" id="image" src="<?php echo (!empty([$get_emp_photo])) ? '../dist/photo/'.$get_emp_photo : '../dist/photo/no-photo-icon.png'; ?>" width="200" height="200" vspace="10" alt="User Avatar">
              </div>
                  ...
                  <div class="col-sm-11">
                   ...
                   <label>Status</label>      
                    <div class="input-group">            
                      <select class="form-control custom-select" name="E_Status">
                  <option disabled selected><?php echo $get_status?></option>
