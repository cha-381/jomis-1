       ...
       <?php }elseif($sched_data['Period']!="" && $sched_data['Month1']=="" && $sched_data['Month2']=="") {?>
        ...
        <?php } ?>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" id="des1"  value="<?php echo $create_description1;?>" <?php echo $btnStatus?> class="form-control" name="Description1">
                      </div>
                  </div>
                </div>
                  ...
                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" id="des2"  value="<?php echo $create_description2;?>" <?php echo $btnStatus?> class="form-control" name="Description2"  >
                      </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" id="des3"  value="<?php echo $create_description3;?>" <?php echo $btnStatus?> class="form-control" name="Description3" >
                      </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                  ...
                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" id="des4"  value="<?php echo $create_description4;?>" <?php echo $btnStatus?> class="form-control" name="Description4">
                      </div>
                  </div>
                </div>
                ...
                <a href="create_job_order.php?objid=<?php echo $get_objid?> " class="btn btn-default"><b>Back</b></a>
