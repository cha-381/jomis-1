       ...
       <span class="brand-text font-weight-light"> <p> Dashboard </p>
            ...
            <ul class="nav nav-treeview">
             ...
             <a href="employeedetails.php?ID=<?php echo
                            "22";?>" class="nav-link"  style="text-indent: 20px;">
             ...
             <a href="page.php" class="nav-link"  style="text-indent: 20px;">
               <img src="../dist/img/source.gif" alt="" class="brand-image img-square" width="25" height="25" style="opacity: "> <p  style="text-indent: 13px;"> List of Active Employees</p>
             </a>
              </li>
                   </ul>
