...
<?php } ?>
          ...
          <br>
            <div class="card-body">
             ...
             <div class="form-group">
               ...
               <div class="col-md-12">
                <input type="text" class="form-control" name="lastname" placeholder="Lastname" value="<?php echo $get_db_ext_name;?>" required>
               </div>
             </div>
              ...
              <div class="form-group">
                ...
                <select class="form-control custom-select" name="department">">
                  <option selected><?php echo $get_db_department?></option>
    ...
    $get_department['department']; ?>"><?php echo $get_department['department']; ?></option> <?php } ?>
             ...
             <div class="form-group">
               ...
               <div class="col-md-12">
                <input type="text" required class="form-control" name="code" style="border-color: red" placeholder="Code" value="<?php echo $get_db_department_code;?>">
               </div>
             </div>
             ...
             <div class="form-group">
               ...
               <div class="col-md-12">
                <input type="text" required class="form-control" name="abbre" style="border-color: red" placeholder="Abbreviation" value="<?php echo $get_db_abbre;?>">
               </div>
             </div>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
               ...
               <div class="col-md-12">
                <input type="text" class="form-control" name="abbre" style="border-color: red" placeholder="Account Type" value="<?php echo $get_db_account_type;?>">
               </div>
             </div>
           ...
           <div class="footer" align="center">
             <a href="create_job_order_edit.php?objid=<?php echo $get_objid?> " class="btn btn-default"><b>Back</b></a>
                 <input type="submit" name="edit" <?php echo $btnStatus?> class="btn btn-success" value="Update">
