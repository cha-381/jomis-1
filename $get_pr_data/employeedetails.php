...
<div class="card">
         ...
         <div class="col-md-9">
          ...
          <div class="card card-info">
             ...
             <?php if ($emp_data['Status']=="Active") {?> 
                     <td style="text-align:center;"><?php echo $emp_data['Status'];?></td>
            ...
            <?php }elseif($emp_data['Status']=="Inactive") {?>  
                         <td style="text-align:center; color:red;"><?php echo $emp_data['Status'];?></td>
                   <td align="center">
