...
<input type="hidden" id="news" name="new_number"  class="form-control" value="<?php echo $countjo;?>" required>
              ...
              <input type="hidden" id="nonen" class="form-control" value="<?php echo $JobOrder;?>"  required>
         ...
         <button type="button" href="#myModal" id="myBtn"  <?php echo $btnAdd;?> class="btn btn-success">Add Job Order</button></h3>
  ...
  border-spacing="0;" width= "100%;">
      ...
      <?php }elseif($sched_data['Period']!="" && $sched_data['Month1']!="" && $sched_data['Month2']=="") {?>
       ...
       <select class="form-control custom-select" name="job_schedules">
                  <option selected><?php echo $scheds?></option>
