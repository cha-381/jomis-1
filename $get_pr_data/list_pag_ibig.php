  ...
  <section class="content-header">
    ...
    <div class="col-sm-6">
      ...
      <img class="brand-image img-square "  
                       ...
                       alt="User profile picture" width="30" height="30"> Pag-Ibig
    ...
    <section class="content">
      <div class="row">
        ...
        <div class="form-group">
          ...
          <input type="hidden" id= "PayrollNo" align="right" name="" value="<?php echo $payr?>" class="form-control">
           <input type="hidden" id= "payr" align="right" name="" value="<?php echo $pay?>" class="form-control">
            ...
            <form role="form" method="get" action="<?php htmlspecialchars("PHP_SELF"); ?>">
                ...
                <table id="users" class="table table-bordered ">
                  <thead>
                       ...
                       <tr style="font-size: 16px; background-color: hsla(235, 100%, 86%, 0.3)">
                      ...
                      <th  width="15%" style="text-align:center; background-color: hsla(99, 43%, 51%, 0.3)">Pag-Ibig No.</th>
                  ...
                  <tbody>
                     <?php while ($get_project = $get_pag_data-> fetch(PDO::FETCH_ASSOC)) { ?>
                    <tr>
                   ...
                   <td> <strong><?php echo $get_project['PayrollNo'];?></strong></td>
                    ...
                    <td style="text-align:left;"><?php echo $get_project['PagIbigNo'];?></td>
                    <td style="text-align:left;"><?php echo $get_project['CoveredMonth'].","." ".$get_project['year'];?></td>
                     <td style="text-align:right;"><b><?php echo "P"?></b>
                    <td style="text-align:right;"><b><?php echo number_format($get_project['Pag_ibig_amount'],2);?></b></td></td>
...
<div id="myModal" class="modal">
    ...
    <div class="modal-header bg-primary">
     ...
     <form class="form-horizontal" method="POST" action="insert_pag_ibig.php">
   ...
   $get_name['PayrollNo']; ?>"><?php echo  $get_name['PayrollNo']?></option> <?php } ?>
            ...
            <div class="col-md-5"> 
                   <div class="form-group"> 
                    <label> Amount: </label>
                    <input type="text" id= "pag_ibig_amount" align="right" name="pagamount" class="form-control">
                  </div>
                    </div>
                    </div>
                </div>
