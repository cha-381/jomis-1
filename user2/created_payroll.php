...
<input type="text" name="pay_no" id="pay_no" readonly value="<?php echo $payroll;?>" class="form-control">         </div>
  ...
  <input style="text-align: right;" type="hidden" readonly id="amount2" name="" class="form-control"> 
 ...
 function sync2(int)
{
  ...
  var jo_amount1 = document.getElementById('jo_amount1');
  amount.value = (amount2.value*1)-(pay_amount.value*1);
   amount2.value = (amount1.value*1)+(jo_amount1.value*1);
