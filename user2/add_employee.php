 ...
 <label><i style="color:red; font-size: 14pxs;">Reference Number</i></label>
                    ...
                    <div class="col-sm-3">
                     ...
                     <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" <?php echo $btnStatus; ?> name="spouseOcc" required>
                      </div>
                      </div>
                    </div>
        ...
        <b> <label>Date of Birth</b><i style="color: red;"> (mm/dd/yyyy)</i></label>
                ...
                <div class="row">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB1" placeholder="Date" value="<?php echo ""?>">
              </div>
          </div>
        </div>
                  </div>
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB2" placeholder="Date"  value="<?php echo ""?>">
              </div>
          </div>
        </div>
                  </div>
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB3" placeholder="Date"  value="<?php echo ""?>">
              </div>
          </div>
        </div>
                  </div>
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB4" placeholder="Date"  value="<?php echo ""?>">
              </div>
          </div>
        </div>
                  </div>
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="childB5" placeholder="Date" value="<?php echo ""?>">
              </div>
          </div>
        </div>
                  </div>
    ...
    <?php } ?>  <?php } ?>
             ...
             <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" <?php echo $btnStatus; ?> name="others" required>
                      </div>
                    </div>    
                ...
                <hr class="dashed">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text "><i class="fa fa-calendar"></i></span>  </div>
                <input type="text" id="datepicker" <?php echo $btnStatus; ?> class="form-control" name="datectc" placeholder="Date" value="" required>
              </div>
                      </div>
                      </div>
