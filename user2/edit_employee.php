...
<input type="hidden" class="form-control"  id="pic" name="EmpPhoto" value="<?php echo $get_emp_photo;?>" required>
 <input type="hidden" class="form-control" name="ID" value="<?php echo $id_emp;?>" required>
  <input type="hidden" class="form-control" readOnly=true id = "emp_id" name="EmpCode" value="<?php echo $get_emp_id; ?>">
             ...
             <label align="right"><i style="color:grey">*********</i>Uploaded Photo<i style="color:grey">*********</i></label>
             ...
             <div class="col-sm-11">
                      <div class="row">
                        <input  <?php echo $btnStatus; ?> type="text" style="text-align: center" class="form-control" name="EmpCode"  value="<?php echo $get_emp_code;?>" placeholder="Enter ID" required>
...
<?php } ?>
    ...
    $get_brgy['barangay']; ?>"><?php echo $get_brgy['barangay']; ?></option> <?php } ?>
                ...
                <input  <?php echo $btnStatus; ?> type="text" id="datepicker" readonly value="<?php echo $get_emp_birth;?>" class="form-control" name="EmpBirth" placeholder="Date">
              </div>
          </div>
        </div>
                      <div class="col-sm-3">
...
<?php }elseif($get_status=='Inactive') {?>
            <div class="row">
                      ...
                      <div class="form-group">
                        <label>Remarks</label>
                       <input  <?php echo $btnStatus; ?> type="text" style="border-color:red;" class="form-control" value="<?php echo $get_emp_remarks;?>" name="Remarks" required>
                      </div>
                  </div>
                    </div>         
              </div>
  ...
  <div class="container">
        ...
        <b> <label>Date of Birth</b><i style="color: red;"> (mm/dd/yyyy)</i></label>
                ...
                <div class="row">
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text " style="color:red"><i class="fa fa-calendar"></i></span>  </div>
                <input  <?php echo $btnStatus; ?> type="text" id="datepicker" readonly value="<?php echo $get_child1_yr;?>" class="form-control" name="EmpChildB1" placeholder="Date">
              </div>
          </div>
        </div>
                  </div>
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text " style="color:red"><i class="fa fa-calendar"></i></span>  </div>
                <input  <?php echo $btnStatus; ?> type="text" id="datepicker" readonly value="<?php echo $get_child2_yr;?>" class="form-control" name="EmpChildB2" placeholder="Date">
              </div>
          </div>
        </div>
                  </div>
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text " style="color:red"><i class="fa fa-calendar"></i></span>  </div>
                <input  <?php echo $btnStatus; ?> type="text" id="datepicker" readonly value="<?php echo $get_child3_yr;?>" class="form-control" name="EmpChildB3" placeholder="Date">
              </div>
          </div>
        </div>
                  </div>
                 ...
                 <div class="input-group-addon input-group-prepend">
                <span class="input-group-text " style="color:red"><i class="fa fa-calendar"></i></span>  </div>
                <input  <?php echo $btnStatus; ?> type="text" readonly id="datepicker" value="<?php echo $get_child4_yr;?>" class="form-control" name="EmpChildB4" placeholder="Date">
              </div>
          </div>
        </div>
                  </div>
                 ...
                 <div class="input-group-addon input-group-prepend" >
                <span class="input-group-text " style="color:red"><i class="fa fa-calendar" ></i></span>  </div>
                <input  readonly <?php echo $btnStatus; ?> type="text" id="datepicker" value="<?php echo $get_child5_yr;?>" class="form-control" name="EmpChildB5" placeholder="Date">
              </div>
          </div>
        </div>
                  </div>
    ...
    <?php } ?>  <?php } ?>
              ...
              <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <input type="text"  <?php echo $btnStatus; ?> class="form-control" value="<?php echo $get_emp_others;?>"name="Others" required>
                      </div>
                      </div>
             ...
             <div class="col-sm-3">
                ...
                <input  <?php echo $btnStatus; ?> type="text" id="datepicker" value="<?php echo $get_emp_joingdate;?>" class="form-control" name="EmpJoingdate" placeholder="Date">
                       ...
                       <div class="col-sm-3">
                      <div class="form-group">
                        <b><label>Date End</b><i style="color:red"> (yyyy-mm-dd)</i></label></label>
                        <input  <?php echo $btnStatus; ?> type="text" class="form-control" value="<?php echo $get_emp_designation;?>" name="EmpDesignation" required>
                      </div>
                    </div>
                    </div>
