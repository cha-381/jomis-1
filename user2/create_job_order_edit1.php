...
<?php include 'includes/update_edit_edit_jo.php'; ?>
...
<input type="text" id="news" name="new_number"  class="form-control" value="<?php echo  $get_objid;?>" required>
              <input type="hidden" id="none" class="form-control" value="<?php echo $details_no;?>"  required>
             <input type="text" id="nonen" class="form-control" value="<?php echo $JobOrder;?>"  required>
         ...
         <button type="button" href="#myModal" id="myBtn" class="btn btn-success">Add Employee</button></h3>
      ...
      <?php }elseif($sched_data['Period']!="" && $sched_data['Month1']!="" && $sched_data['Month2']=="") {?>
                ...
                <table id="user" class="table-secondary">
                  ...
                  <tbody>
                     ...
                     <?php while ($get_project = $get_create_data-> fetch(PDO::FETCH_ASSOC)) { ?>
                       <?php if ($get_project['JobOrderNo']==$JobNo) {
                     ?> 
             ...
             <!-- /.box-body -->
               ...
               <form class="form-horizontal" method="POST" action="<?php htmlspecialchars("PHP_SELF"); ?>">
                ...
                <div class="row">
                   ...
                   <?php if ($finalcount=="") {
                     ?> 
                        <input type="text" id="laborers" class="form-control" name="jo_laborers" value="0" required>
                   <?php }elseif($finalcount!="") {?>
                        <input type="text" id="laborers" class="form-control" name="jo_laborers" value="<?php echo $totalcount;?>" required>
                    <?php } ?>   
                      </div>
                    </div>
       ...
       <select class="form-control custom-select" name="job_schedules">
                  ...
                  <option>Saturdays and Sundays</option>
                   ...
                   <input type="hidden" id="news" name="JobOrderNo"  class="form-control" value="<?php echo $JobNo;?>" required>

                      <input type="hidden" id="amount" class="form-control" name="Amount" value="<?php echo $finalcount;?>"  required>


                      <input type="hidden" id="" class="form-control"  name="Charges" value="<?php echo $createjo_charges;?>"  required>

                      <input type="hidden" id="amount" class="form-control" name="code" value="<?php echo $code;?>"  required>

                      <input type="hidden"  class="form-control" name="Laborers" value="<?php echo $totalcount;?>"  required>

                    <label style="text-align:right; font-size: 18px;"><i>Available Balance:</i> <b class="mb-0 font-weight-bold bg-yellow"><?php echo number_format(($count+$amount)-$finalcount, 2);?></b></label>

                    <input type="hidden" name="PreviousBalance" value="<?php echo ($count+$amount)-$finalcount;?>" class="form-control">  

                    <input type="hidden"  id="jonum" value="<?php echo $JobNo;?>" class="form-control">  

                     <input type="hidden" id="balance"  class="form-control" value="<?php echo $count-$finalcount;?>" name="jo_bal" required>

                      <input type="hidden" id="prevbalance"  class="form-control" value="<?php echo $count;?>" name="jo_bal" required>
                    ...
                    <hr>
                     <div class="box-footer" align="right">
                      ...
                      <button type="submit" class="btn btn-success" <?php echo $btnStatus;?> name="update" value="save"><b>Update</b></button>
...
<input type="hidden" name="jo_uniq" id="jo_uniq" value="" class="form-control">     
...
<input type="text" name="jo_prev_prj" id="jo_total_amount" value="<?php echo $prevbal2?>" class="form-control">    

<input type="text" name="jo_uniq" value="<?php echo $uniqjo?>" class="form-control">  
<input type="text" name="jo_prev_amount" id="jon1" value="<?php echo $amount2?>" class="form-control"> 
                  <div class="form-group"> 
                     <div class="row">
                      <div class="col-sm-8">
