             ...
             <div class="row">
              ...
              <input type="hidden" name="Department" class="form-control" value="<?php echo  $get_proj_dept?>" >
               ...
               <input type="hidden" name="Years" class="form-control" value="<?php echo  $get_proj_years?>" >
                ...
                <input type="hidden"  id="total2" style="background-color: lightgreen;" name="Amount" class="form-control" value="<?php echo $get_Total_Amount?>" placeholder="Total Amount" >     

              <input type="hidden" style="background-color: red;" name="TotalAmount" id="total" class="form-control" value="<?php echo $get_rate1*$get_day1?>" placeholder="Total Amount" >

                <input type="hidden"  style="background-color: orange;" id="total1" class="form-control" value="<?php echo $get_sched_amount?>"  > 

                 <input type="hidden" style="background-color: yellow;" id="total8" class="form-control" value="<?php echo $get_sched_amount-$get_Total_Amount?>" placeholder="Total Amount" > 

                 <input type="hidden"  id="total4" class="form-control" value="<?php echo $get_Total_Amount?>" placeholder="Total Amount" > 
   ...
   <div id="myModal2" class="modal" role="dialog" data-backdrop="static" data-keyboard="false">
    ...
    <div class="modal-header bg-danger">
     ...
     <form class="form-horizontal" method="POST"action="<?php htmlspecialchars("PHP_SELF"); ?>">
              ...
              <input type="text" id="number1" style="background-color: red;" name="" class="form-control" value="<?php echo $get_rate1*0?>" name="TotalAmount" placeholder="Total Amount" >
