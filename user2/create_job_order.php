           ...
           <i style="font-size:17px"><i style="color:red" align="center">*Laborers are directed to proceed to jobsite namely:</i></i>  
              ...
              <div class="jumbotron">
                <div class="form-group"> 
                     <div class="row">
                      <div class="col-sm-12">
              <label style="text-align:right; font-size: 30px;" name="job_no"><i>Job Order #:</i> <b class="mb-0 font-weight-bold bg-yellow"><?php echo $uniqjo."-".$JobNo;?></b></label>
...
<input type="hidden" name="jo_total_amount" id="jo_total_amount" value="<?php echo $jo_total_amount?>" class="form-control">   

<input type="hidden" name="jo_total_amount" id="jo_total_amount" value="<?php echo $db_department?>" class="form-control" name="jo_dept">     
...
<input type="hidden" name="jo_total_amount" id="jo_total_amount" value="<?php echo $db_charges?>" class="form-control" name="jo_charges"> 
 ...
 <?php if ($get_name['E_Status']=='Active' && $get_name['Department']==$db_department && $get_name['ProjectName']==$db_prjname OR $get_name['Department']==$db_all) {?>
