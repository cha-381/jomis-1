                ...
                <div class="row">
                  ...
                  <div class="col-sm-8">
                      ...
                      <div class="row">
                       <div class="col-sm-4">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_item1;?>" <?php echo $btnStatus?> class="form-control" name="Item1" >
                      </div>
                  </div>

                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_description1;?>" <?php echo $btnStatus?> class="form-control" name="Description1" >
                      </div>
                  </div>
                </div>
                  ...
                  <div class="row">
                       <div class="col-sm-4">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_item2;?>" <?php echo $btnStatus?> class="form-control" name="Item2" >
                      </div>
                  </div>

                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_description2;?>" <?php echo $btnStatus?> class="form-control" name="Description2" >
                      </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                       <div class="col-sm-4">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_item3;?>" <?php echo $btnStatus?> class="form-control" name="Item3" >
                      </div>
                  </div>

                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_description3;?>" <?php echo $btnStatus?> class="form-control" name="Description3" >
                      </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                       <div class="col-sm-4">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_item4;?>" <?php echo $btnStatus?> class="form-control" name="Item4" >
                      </div>
                  </div>

                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_description4;?>" <?php echo $btnStatus?> class="form-control" name="Description4" >
                      </div>
                  </div>
                </div>
                 ...
                 <div class="row">
                       <div class="col-sm-4">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_item5;?>" <?php echo $btnStatus?> class="form-control" name="Item5" >
                      </div>
                  </div>

                  <div class="col-sm-8">
                      <div class="form-group">
                        <input type="text" value="<?php echo $create_description5;?>" <?php echo $btnStatus?> class="form-control" name="Description5" >
                      </div>
                  </div>
                </div><hr class="dashed">
               
                <a href="create_job_order.php" class="btn btn-default"><b>Back</b></a>
