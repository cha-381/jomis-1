              ...
              <ul class="nav nav-pills flex-column">
                <li class="nav-item active">
                  <a href="#myModal" id="myBtn" class="nav-link">
                    <i class="fa fa-inbox"></i>  Create New Budget
                    <span class="badge bg-primary float-right"><?php echo $get_prj_data->rowCount()?></span>
                  </a>
                </li>
                <li class="nav-item">
                  <a href="#myModal2" id="myBtn2" class="nav-link">
                    <i class="fa fa-folder-open"></i> Create Supplemental Budget
                  </a>
                </li>
                 </ul>
            </div>
