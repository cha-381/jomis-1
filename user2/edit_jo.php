     ...
     <!-- Main content -->
           ...
           <i style="font-size:17px"><i style="color:red" align="center">*Fill up the form completely.</i></i>  
            <form method="post" action="" enctype="multipart/form-data">   
              ...
              <div class="row">
                 <div class="col-12">
                 <label style="text-align:right; font-size: 30px;"><i>Job Order #:</i> <b class="mb-0 font-weight-bold bg-yellow"><?php echo $uniqjo."-".$no_jobOrder;?></b></label>
               </div>
             </div>
    ...
    $get_rated['Salary']; ?>"><?php echo $get_rated['Salary']?></option> <?php } ?>
                  ...
                  <option>Holidays</option>  
                   ...
                   <div class="box-footer" align="right">
                        ...
                        <a href="create_job_order.php?objid=<?php echo $get_no;?>" class="btn btn-default"><b>Back</b></a>
