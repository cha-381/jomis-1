...
class Paginator{
	...
	public function __construct($total=0,$mid_range=7,$ipp_array=array(10,25,50,100,"All")) {
		...
		if($this->num_pages > 10) {
			$this->return = ($this->current_page > 1 And $this->total_items >= 10) ? "<li><a href=\"$_SERVER[PHP_SELF]?page=".($this->current_page-1)."&ipp=$this->items_per_page$this->querystring\">Previous</a></li> ":"<li><a class=\"inactive\" href=\"#\">Previous</a> </li>";
			...
			for($i=1;$i<=$this->num_pages;$i++) {
				if($this->range[0] > 2 And $i == $this->range[0]) $this->return .= "<li><a href='javascript:;'>...</a> ";
				...
				if($this->range[$this->mid_range-1] < $this->num_pages-1 And $i == $this->range[$this->mid_range-1]) $this->return .= " <li><a href='javascript:;'>...</a></li> ";
			}
