...
<?php } ?>
                ...
                <!-- /.widget-user-image --> 
                <h1 class="widget-user-username"><?php echo $get_emp_fname . " " . $get_emp_mname[0] ."." . " " . $get_emp_lname." ".$get_emp_ename ?></h1>
              ...
              <div class="card-footer p-0">
                <ul class="nav flex-column">
                  ...
                  <li class="nav-item">
                    <a href="#" class="nav-link">
                     Years in Serivce  <span class="float-right badge bg-danger"><?php echo $get_start;?></span>
                    </a>
                  </li>
                </ul>
    ...
    <!-- Main content -->
          ...
          <?php echo $alert_msg;?>
              ...
              <label>Year</label>
               <div class="col-md-12">
                ...
                <div class="form-group">
                 <label>Award</label>
               <div class="col-md-12">
                <input type="text" class="form-control"   value="<?php echo $get_edu_col_award;?>" readonly>
               </div>
           ...
           <hr>
             ...
             <div class="form-group">
               ...
               <div class="col-md-12">
                <input type="text" class="form-control" name="SecondaryYear"  value="<?php echo $get_edu_sec_yr;?>" readonly>
                 ...
                 <label>Award</label>
               <div class="col-md-12">
                <input type="text" class="form-control"   value="<?php echo $get_edu_sec_award;?>" readonly>
               </div>
             ...
             <div class="form-group">
               ...
               <div class="col-md-12">
                ...
                <div class="form-group">
                 <label>Award</label>
               <div class="col-md-12">
                <input type="text" class="form-control"   value="<?php echo $get_edu_elem_award;?>" readonly>
               </div>
            </div>
             ...
             <label><i class="h5 mb-0 font-weight-bold bg-yellow">VOCATIONAL/TRADE COURSE</i></label>

              <div class="form-group">
                 <label>School Grauated</label>
               <div class="col-md-12">
                <input type="text" class="form-control"  value="<?php echo $get_edu_voc_sch;?>" readonly>
               </div>
             ...
             <div class="form-group">
                 <label>Year</label>
               <div class="col-md-12">
                <input type="text" class="form-control"  value="<?php echo $get_edu_voc_yr;?>" readonly>
              </div>

                <div class="form-group">
                 <label>Award</label>
               <div class="col-md-12">
                <input type="text" class="form-control"   value="<?php echo $get_edu_voc_award;?>" readonly>
               </div>
            </div>
            ...
            <br>
             ...
             <label><i class="h5 mb-0 font-weight-bold bg-yellow">GRADUATE STUDIES</i></label>

              <div class="form-group">
                 <label>School Grauated</label>
               <div class="col-md-12">
                <input type="text" class="form-control"  value="<?php echo $get_edu_gra_sch;?>" readonly>
               </div>
             ...
             <div class="form-group">
                 <label>Year</label>
               <div class="col-md-12">
                <input type="text" class="form-control"  value="<?php echo $get_edu_gra_yr;?>" readonly>
              </div>

                <div class="form-group">
                 <label>Award</label>
               <div class="col-md-12">
                <input type="text" class="form-control"   value="<?php echo $get_edu_gra_award;?>" readonly>
               </div>
            </div>
