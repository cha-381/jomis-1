...
<div class="col-sm-11">
                   ...
                   <label>Account Type</label>      
                    <div class="input-group" >            
                      <select class="form-control custom-select" disabled style="border-color:red;" <?php echo $btnStatus; ?> name="account_type" required>
   ...
   <div class="col-sm-11">
                   ...
                   <label>Status</label>      
                    <div class="input-group">            
                      <select class="form-control custom-select" disabled <?php echo $btnStatus; ?> style="border-color:red;" name="status" required>
             ...
             <div class="card-body">
                   ...
                   <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled <?php echo $btnStatus; ?> name="lastname" value="<?php echo $user_last_name?>" required>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label>First Name</label>
                         <input type="text" class="form-control" disabled <?php echo $btnStatus; ?> name="firstname" value="<?php echo $user_first_name?>" required>
                      </div>
                    </div>
                  </div>
                ...
                <div class="row">
                     <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled <?php echo $btnStatus; ?> value="<?php echo $user_middle_name?>" name="middlename" required>
                      </div>
                    </div>
                      ...
                      <label>Name Extension</label>
                         <input type="text" value="<?php echo  $user_ext_name ?>" disabled class="form-control" <?php echo $btnStatus; ?> name="ext_name">
                      </div>
                      </div>
                    </div>
               ...
               <label for="inputName">Department</label>
                <select class="form-control custom-select" disabled id="joName" <?php echo $btnStatus; ?> style="border-color: red;" onchange="sync()">
    ...
    $get_department['department']; ?>"><?php echo $get_department['department']; ?></option> <?php } ?>
             ...
             <input type="hidden"  class="form-control" value="<?php echo  $user_abbre ?>" <?php echo $btnStatus; ?> name="abbre" id="abbre">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" disabled value="<?php echo  $user_position ?>" <?php echo $btnStatus; ?> name="position" required>
             </div>  
             </div>                      
             </div> 
                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        <label>Email</label>
                        <input type="text" class="form-control" disabled <?php echo $btnStatus; ?> value="<?php echo  $user_email_ad ?>" name="email" required>
                      </div>
                  </div>
                       <div class="col-sm-5">
                      <div class="form-group">
                        <label>Contact Number</label>
                        <input type="text" class="form-control" disabled value="<?php echo  $user_contact_number ?>"<?php echo $btnStatus; ?> name="contact_number" required>
                      </div>
                  </div>
                  </div>
                 ...
                 <input type="text" class="form-control" disabled <?php echo $btnStatus; ?> value="<?php echo  $user_user_name?>" name="username" placeholder="Username">
               </div>
             </div>
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" <?php echo $btnStatus; ?> value="<?php echo  $user_password?>" name="password" placeholder="Password">
            </div>
               </div>
             </div> 
              </fieldset>
                ...
                <div class="row">
                   <div class="col-sm-4 border-right">
                    <div class="description-block">
                       <a href="edit_user.php?user_id=<?php echo $id_user?>" <?php echo $btnNew; ?> <?php echo $btnStatus; ?> class="btn btn-primary" style="padding: 5px 120px; font-size: 18px">Back</a>
                    </div>
                    <!-- /.description-block -->
                  </div>
                  <!-- /.col -->
