  ...
  <!-- /.widget-user -->
   <form method="post" action="" enctype="multipart/form-data">
         ...
         <input type="hidden" class="form-control" name="userstatus" placeholder="Firstname" required>
             ...
             <div class="form-group">
              ...
              <div class="form-group">
                ...
                <div class="col-md-12">
                <select class="form-control custom-select" onclick="mysync()" id="prjName">
    ...
    $get_department['department']; ?>"><?php echo $get_department['department']; ?></option> <?php } ?>
            ...
            <input type="text" class="form-control" id="abbre" name="abbre" >
            <input type="text" class="form-control" id="code" name="code" >
            <input type="text" class="form-control" id="dept" name="department" placeholder="Department" >
