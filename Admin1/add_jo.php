<?php
  ...
  if (isset($_POST['insert'])) {
    ...
    $emp_child6 = $_POST['child6'];
    $emp_child7 = $_POST['child7'];
    $emp_child8 = $_POST['child8'];
    $emp_child9 = $_POST['child9'];
    $emp_child10 = $_POST['child10'];
    $emp_child_birth1 = $_POST['childB1'];
    $emp_child_birth2 = $_POST['childB2'];
    $emp_child_birth3 = $_POST['childB3'];
    $emp_child_birth4 = $_POST['childB4'];
    $emp_child_birth5 = $_POST['childB5'];
    $emp_child_birth6 = $_POST['childB6'];
    $emp_child_birth7 = $_POST['childB7'];
    $emp_child_birth8 = $_POST['childB8'];
    $emp_child_birth9 = $_POST['childB9'];
    $emp_child_birth10 = $_POST['childB10'];
    $user = $_POST['user'];
    $end = $_POST['enddate'];
   ...
   ';
    ...
    ':citizen'        =>     $emp_citizen,
     ...
     ':childB5'          =>    $emp_child_birth5,
       ':childB6'          =>    $emp_child_birth6,
     ':childB7'          =>    $emp_child_birth7,
     ':childB8'          =>    $emp_child_birth8,
     ':childB9'          =>    $emp_child_birth9,
     ':childB10'          =>    $emp_child_birth10,
     ':user'          =>    $user,
      ':remarks'         =>    $emp_remarks
      ]);
