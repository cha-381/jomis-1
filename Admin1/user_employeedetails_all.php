 ...
 <div class="container-fluid">
        <div class="row">
         <div class="col-12 col-sm-6 col-md-4">
          ...
          <?php if ($db_department==$get_allemp_data) {?>
                <?php echo $get_allemp_data->rowCount()?>
            <?php }elseif($db_department<>$get_allemp_data) {?>
               <?php echo $get_allemp_data->rowCount()?>
               <?php } ?>
                </span>
              </div>
         ...
         <div class="col-md-9">
          ...
          <div class="card card-info">
                 ...
                 <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Name.." title="Type in a name" style="                 background-position: 10px 10px;
                  ...
                  <tr>
            <?php if ($emp_data['E_Status']=="Active" And $emp_data['EmpDept']=="All")  {?> 
                   <td><?php echo $n++; ?></td>
             ...
             <?php if ($emp_data['E_Status']=="Active")  {?> 
                     <td style="text-align:center;" ><?php echo $emp_data['E_Status'];?></td>
                       ...
                       <td align="center">
                          <a class="btn btn-outline-info btn-xs" href="user_employeedetails_all.php?ID=<?php echo $emp_data['ID']; ?>" data-toggle="tooltip" title="Profile Details"><img src="../dist/img/id.jpg" alt="" class="brand-image img-square" width="30" height="30" style="opacity: ">
                          </a>                          
                    </td>
            ...
            <?php }elseif($emp_data['E_Status']=="Inactive") {?>  
                   ...
                   <td align="center">
                          <a class="btn btn-outline-danger btn-xs" href="user_employeedetails_all.php?ID=<?php echo $emp_data['ID']; ?>" data-toggle="tooltip" title="Profile Details"><img src="../dist/img/fire.png" alt="" class="brand-image img-square" width="30" height="30" style="opacity: ">
                          </a>  
