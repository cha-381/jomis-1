         ...
         <div class="col-12 col-sm-6 col-md-4">
          ...
          <span class="info-box-icon bg-info elevation-1"> <i ><img src="../dist/img/emp.png" alt="" class="brand-image img-square" width="70" height="65" style="opacity: "> </i></span>
              ...
              <div class="info-box-content">
                ...
                <?php echo $get_all_data->rowcount()?>
...
<?php }elseif($get_emp_mname!='' && $get_emp_fname!='' && $get_emp_lname!='' && $get_emp_ename=='') {?>
   <input type="hidden" class="form-control" name="Status" readonly="true" value="<?php echo $get_emp_id;?>" >
                ...
                <h3 class="profile-username text-center"><?php echo ucwords($get_emp_fname . " " . $get_emp_mname[0] ."." . " " . $get_emp_lname) ?></h3>

                 <strong><p class="text-muted text-center"><?php echo $get_emp_designation?></p></strong>
                <p class="text-muted text-center"><?php echo $get_emp_category?></p>
 ...
 <!-- About Me Box -->
            <div class="card card-outline card-primary">
              ...
              <strong><i class="fa fa-calendar"></i> Birth Date <i style="color:red; font-size: 11px;"> (yyyy/mm/dd)</i></strong>
                ...
                <strong><i class="fa fa-user "></i> Date Start<i style="color:red; font-size: 11px;"> (yyyy/mm/dd)</i></strong>
         ...
         <div class="col-md-9">
          ...
          <div class="card card-info">
                 ...
                 <input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search by Name.." title="Type in a name" style="                 background-position: 10px 10px;
                  ...
                  margin-bottom: 12px;"> 
                   <div class="card-body table-responsive p-0" style="height: 795px;">
                  ...
                  <tr>
            <?php if ($emp_data['E_Status']=="Active" And $emp_data['EmpDept']==$db_department OR $emp_data['EmpDept']=='All'  )  {?> 
                   <td><?php echo $n++; ?></td>
                  <td> <?php if ($emp_data['EmpExt']=="")  {?> 
                    <?php echo $emp_data['EmpFname'] . " " . $emp_data['EmpMname'][0] ."." . " " . $emp_data['EmpLname']?></td>
                    <?php }elseif($emp_data['EmpExt']<>"") {?> 
                      <?php echo $emp_data['EmpFname'] . " " . $emp_data['EmpMname'][0] ."." . " " . $emp_data['EmpLname'].","." ".$emp_data['EmpExt']?>
                     <?php } ?> 
             ...
             <?php if ($emp_data['E_Status']=="Active")  {?> 
                     <td style="text-align:center;" ><?php echo $emp_data['E_Status'];?></td>
                       ...
                       <td align="center">
                          <a class="btn btn-outline-info btn-xs" href="user_employeedetails.php?ID=<?php echo $emp_data['ID']; ?>" data-toggle="tooltip" title="Profile Details"><img src="../dist/img/id.jpg" alt="" class="brand-image img-square" width="30" height="30" style="opacity: ">
                          </a>                          
                    </td>
            ...
            <?php }elseif($emp_data['E_Status']=="Inactive") {?>  
                   ...
                   <td align="center">
                          <a class="btn btn-outline-danger btn-xs" href="user_employeedetails.php?ID=<?php echo $emp_data['ID']; ?>" data-toggle="tooltip" title="Profile Details"><img src="../dist/img/fire.png" alt="" class="brand-image img-square" width="30" height="30" style="opacity: ">
                          </a>  
 ...
 <!-- /.tab-pane -->
          ...
          <div class="card">
                ...
                <div class="form-group"> 
                    <div class="col-sm-4">
                <a href="../plugins/TCPDF/User/cardsummary.php?Empcode=<?php echo $get_emp_code?>"  id="myButton" class="btn btn-success btn-block mb-3">Print Summary</a>
              </div>
            </div>
              <div class="card-body table-responsive p-0" style="height: 800px;">
                ...
                <table id="user" class="table table-bordered table-striped table-hover" cellspacing="1" cellpadding="8"  style="background-color: #f1f1f1;" >
                  ...
                  <tbody>
                    ...
                    <td style="text-align:left; font-size:12px"><a href="../plugins/TCPDF/User/job_order.php?JobOrderNo=<?php echo $emp_data['JobOrderNo']?>"><?php echo $emp_data['JobOrderNo'];?></td>
