           ...
           <h3 class="card-title">Details</h3>
                ...
                <div class="card-body">
                  <div class="row">
                    <div class="col-7">
                       <?php if ($db_ext_name=='') {?>
                      <h3 class="lead"><b><i class="h1 mb-0 font-weight-bold bg-yellow"><?php echo ucwords(strtolower($db_first_name . " " . $db_middle_name[0] ."." . " " . $db_last_name)) ?></i></b></h3>
                      <?php }elseif($db_ext_name<>'') {?>
                         <h3 class="lead"><b><i class="h1 mb-0 font-weight-bold bg-yellow"><?php echo ucwords(strtolower($db_first_name . " " . $db_middle_name[0] ."." . " " . $db_last_name.","." ". $db_ext_name)) ?></i></b></h3>
                         <?php } ?>
