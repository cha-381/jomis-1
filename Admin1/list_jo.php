...
<?php include 'includes/navbar.php'; ?>
    ...
    <section class="content">
      ...
      <div class="row">
                ...
                <table id="users" class="table table-bordered table-striped" style="background-color: #f1f1f1;">
                  <thead>
                      ...
                      <th  width="18%" style="text-align:center;">JO #</th>
                       ...
                       <th  width="25%" style="text-align:center;">Charges</th>
                       <th  width="5%" style="text-align:center; font-size: 12px">No. Laborers</th>
                    <th  width="18%" style="text-align:center;">Period Covered</th>
            ...
            $n  =   1; while ($get_list = $get_combine2_data-> fetch(PDO::FETCH_ASSOC)) { ?>
                    ...
                    <td style="text-align:left;"><?php echo ucwords(strtoupper($get_list['ProjectName']));?></td>
                 ...
                 <?php }elseif( $get_list['status']=="" And $get_list['Filenames']=="") {
                     ?>
                          <a class="btn btn-outline-primary btn-xs" href="<?php echo $get_list['Filenames']?> "data-toggle="tooltip" title="Approved File"><img src="../dist/img/approve.png" alt="" class="brand-image img-square" width="30" height="30" style="opacity: ">
                          </a>  
  ...
  <?php } ?>    
                    ...
                    <td align="center">
                    <?php if ( $get_list['Remarks']=="" ) {
                     ?>  
                     <a href="attachement.php?objid=<?php echo
                            $get_list['id_no']; ?>" style="color:blue;"><?php echo "Pending" ?>
                          </a>    

                    <?php }elseif(  $get_list['Remarks']=="Checked") {
                     ?>  
                    <a href="attachement.php?objid=<?php echo
                            $get_list['id_no']; ?>" style="color:green;"><?php echo "Checked" ?> <i class="fa fa-check"> </i>
                          </a>    

                    <?php }elseif(  $get_list['Remarks']=="For Correction") {
                     ?>
                          <a href="attachement.php?objid=<?php echo
                            $get_list['id_no']; ?>" style="color:red;"><?php echo "For Correction" ?>
                          </a> 
  <?php } ?>    
