...
$get_em1_sql= "SELECT COUNT(`objid`) as total FROM `createjo` ";
$get_em1_data = $con->prepare($get_em1_sql);
$get_em1_data->execute();
$get_em1_data->setFetchMode(PDO::FETCH_ASSOC);
while ($result1 = $get_em1_data->fetch(PDO::FETCH_ASSOC)) {
  $count_em1 =  $result1['total']+1;
}
